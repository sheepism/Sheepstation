...
## SheepStation - Sector Marshals
alert-level-theta = Theta
alert-level-theta-announcement = Central Command has called the Theta alert level. Sector Marshals have been deployed to the station.
alert-level-theta-instructions = Crewmembers are advised to comply with Sector Marshals.
